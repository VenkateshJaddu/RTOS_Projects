...
extern xTaskHandle cmd_task_handler;
...
//Timer handler
extern TimerHandle_t timer_handler[4];
...
void led_timer_callback_func(TimerHandle_t);

void rtc_timer_callback_func(TimerHandle_t);
...
#define Ext_LED_1_Pin GPIO_PIN_0
#define Ext_LED_1_GPIO_Port GPIOA
#define Ext_LED_2_Pin GPIO_PIN_1
#define Ext_LED_2_GPIO_Port GPIOA
